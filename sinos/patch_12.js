const patch_12 = (add_node, connect) => {
    add_node(2, 4, `gA`, `gain`, 1)
    add_node(5, 4, `gD`, `gain`, 0.05)
    connect(`gA`, `gD`)
    const l8 = `01234567`
    const i8 = []
    for (const l of l8) {
    ...
    add_node(2, 2, `o2`, `osc`, `sine`, 30)
    connect(`m2`, `g2`)
    connect(`g2`, `o2.detune`)
    connect(`o2`, `gf2`)

    add_node(5, 0, `m5`, `osc`, `sine`, 30)
    add_node(5, 1, `g5`, `gain`, 1400)
    add_node(5, 2, `o5`, `osc`, `sine`, 30)
    connect(`m5`, `g5`)
    connect(`g5`, `o5.detune`)
    connect(`o5`, `gf5`)
    ...
    add_node(3, 0, `m3`, `osc`, `sine`, 30)
    add_node(3, 1, `g3`, `gain`, 1400)
    add_node(3, 2, `gg3`, `gain`, 1400)
    connect(`m3`, `g3`)
    connect(`g3`, `g2.gain`)
    ...
    add_node(4, 0, `m4`, `osc`, `sine`, 30)
    add_node(4, 1, `g4`, `gain`, 1400)
    add_node(4, 2, `gg4`, `gain`, 1400)
    connect(`m4`, `g4`)
    connect(`g4`, `g5.gain`)
    connect(`g4`, `m5.detune`)
    connect(`o5`, `gg4`)

    add_node(6, 0, `m6`, `osc`, `sine`, 30)
    add_node(6, 1, `g6`, `gain`, 1400)
    connect(`m6`, `g6`)
    connect(`g6`, `g5.gain`)
    connect(`g6`, `m5.detune`)
