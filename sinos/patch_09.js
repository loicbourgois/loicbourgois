const patch_09 = (add_node, connect) => {
    ...
    add_node(5, 2, "o3", "osc", "sine", 719.15)
    add_node(5, 1, "g3", "gain", 91.53)
    add_node(5, 0, "o2", "osc", "sine", 669.95)
    add_node(4, 0, "g2", "gain", 1502.1192802499997)
    add_node(4, 1, "o1", "osc", "sine", 194.22)
    add_node(3, 2, "g1", "gain", 51.36815294527349)
    add_node(3, 1, "s8", "shaper", 2.7062359698167153)
    add_node(3, 0, "m3", "clock_mult", 3)
    add_node(2, 0, "c1", "clock", 158)
