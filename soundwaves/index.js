// 2 first sliders can be used to change patern
const conf = {
  red_amount: 0.8,
...
const uniforms = {
  ...
  slider_6: {
    value: 0.0,
    uniform_location: gl.getUniformLocation(program, 'slider_6'),
    setter: set_uniform1f,
    slider: document.querySelector('#slider_6'),
  },
}
...
const handle_controls = () => {
  ...
  update_uniform_slider_value(uniforms.slider_6)
}
const render_loop = () => {
