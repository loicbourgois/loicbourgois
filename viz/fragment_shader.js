...
float t = time_ms * 0.001;
  ...
  //
  vec2 dimensions = vec2(20.0, 20.0);
  pix.xy = pix.xy * dimensions;
  color = vec4(pix.x, pix.y, 0.0, 1.0);
  int p_count = 1;
  vec3 particles[100];
  int particle_materials[100];


  particles[0] = vec3(10.0, 12.0, 2.0);
  particles[1] = vec3(10.0, 10.0, 2.0);
  particles[2] = vec3(11.72, 11.0, 2.0);
  particles[3] = vec3(10.0-5.0*cos(time_ms/1500.0), 11.0, 2.0);
  particles[4] = vec3(15.0, 15.0, 2.0);
  particles[5] = vec3(5.0, 15.0, 1.0);
  particles[6] = vec3(15.0, 5.0, 5.0);
